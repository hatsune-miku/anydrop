...
pub struct AnyDropServiceConfig {
...
impl Clone for AnyDropServiceConfig {
    fn clone(&self) -> Self {
        Self {
...
#[allow(dead_code)]
impl AnyDropService {
    pub fn new(config: &AnyDropServiceConfig) -> Result<Self, io::Error> {
        // Create services.
    ...
    pub fn config(&self) -> AnyDropServiceConfig {
        self.config.clone()
    }
}
