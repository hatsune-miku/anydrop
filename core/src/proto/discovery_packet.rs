...
//! Generated file from `discovery_packet.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_3_0;

// @@protoc_insertion_point(message:anydrop.DiscoveryPacket)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct DiscoveryPacket {
    // message fields
    // @@protoc_insertion_point(field:anydrop.DiscoveryPacket.address)
    pub address: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:anydrop.DiscoveryPacket.server_port)
    pub server_port: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:anydrop.DiscoveryPacket.group_identifier)
    pub group_identifier: ::std::option::Option<u32>,
    // @@protoc_insertion_point(field:anydrop.DiscoveryPacket.need_response)
    pub need_response: ::std::option::Option<bool>,
    // @@protoc_insertion_point(field:anydrop.DiscoveryPacket.host_name)
    pub host_name: ::std::option::Option<::std::string::String>,
    ///  Stable per-install device identity. Optional for backward compatibility
    ///  with peers that predate this field. Used to group a device's multiple
    ///  addresses / hostnames as one peer, and as the local-remark key.
    // @@protoc_insertion_point(field:anydrop.DiscoveryPacket.device_id)
    pub device_id: ::std::option::Option<::std::string::String>,
    // special fields
    // @@protoc_insertion_point(special_field:anydrop.DiscoveryPacket.special_fields)
...
impl DiscoveryPacket {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_option_accessor::<_, _>(
            "device_id",
            |m: &DiscoveryPacket| { &m.device_id },
            |m: &mut DiscoveryPacket| { &mut m.device_id },
        ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16discovery_packet.proto\x12\x07anydrop\"\xd6\x01\n\x0fDiscoveryPack\
    et\x12\x18\n\x07address\x18\x01\x20\x02(\rR\x07address\x12\x1f\n\x0bserv\
    er_port\x18\x02\x20\x02(\rR\nserverPort\x12)\n\x10group_identifier\x18\
    \x03\x20\x02(\rR\x0fgroupIdentifier\x12#\n\rneed_response\x18\x04\x20\
    \x02(\x08R\x0cneedResponse\x12\x1b\n\thost_name\x18\x05\x20\x02(\tR\x08h\
    ostName\x12\x1b\n\tdevice_id\x18\x06\x20\x01(\tR\x08deviceIdJ\xa7\x05\n\
    ...
    \x01\n\x04\x04\0\x02\x05\x12\x03\r\x02\x20\x1a\xd1\x01\x20Stable\x20per-\
    install\x20device\x20identity.\x20Optional\x20for\x20backward\x20compati\
    bility\n\x20with\x20peers\x20that\x20predate\x20this\x20field.\x20Used\
    \x20to\x20group\x20a\x20device's\x20multiple\n\x20addresses\x20/\x20host\
    names\x20as\x20one\x20peer,\x20and\x20as\x20the\x20local-remark\x20key.\
    \n\n\x0c\n\x05\x04\0\x02\x05\x04\x12\x03\r\x02\n\n\x0c\n\x05\x04\0\x02\
    \x05\x05\x12\x03\r\x0b\x11\n\x0c\n\x05\x04\0\x02\x05\x01\x12\x03\r\x12\
